...
//                  $('.cart > ul').load('index.php?route=common/cart/info ul li');
                    ...
                    $('.cart > .cart-form--your-choose').load('index.php?route=common/cart/info .cart-form--your-choose .cart-form--parent', function(){
...
var checkout = {
    'view' : function(){
        ...
        $.ajax({
            url: 'index.php?route=common/checkout',
            //dataType: 'html',
            dataType: 'html',
...
var other = {
    'cartformorderdetail': function(product_id) {
        console.log('qqqq');
		$(".cart-form--your-choose").removeClass('active');
    },
    'cartprev': function(e){
