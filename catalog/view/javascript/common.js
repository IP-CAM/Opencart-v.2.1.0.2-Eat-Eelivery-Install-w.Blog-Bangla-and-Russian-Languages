...
$(document).ready(function() {
	...
	// sinhronize 
	$(".tot").html($(".cart-form__eat-box__total").html());
...
//	});
    ...
    $('.cart-form__eat-box__counter').children('.arrow--straight').click(function(){
        $(this).parents('.cart-form__eat-box__counter').find('input').attr('value', Number($(this).parents('.cart-form__eat-box__counter').find('input').val())+1 );
    });

    $('.cart-form__eat-box__counter').children('.arrow--inverse').click(function(){
        if($(this).parents('.cart-form__eat-box__counter').find('input').val()!=="1"){
            $(this).parents('.cart-form__eat-box__counter').find('input').attr('value', Number($(this).parents('.cart-form__eat-box__counter').find('input').val())-1 );
        }
    });
});

    $(".cart, .cart-form__delete").click(function(){
        return false;
    });
