<?php echo $header; ?>
        <div class="steps">
			<div class="container con-mod">
				<div class="steps__inner"></div>
			</div>
		</div>
		<section class="why-we">
			<div class="container con-mod">
				<div class="why-we__inner">
					<div class="why-we__title title">
					...
					<div class="why-we__container">
						...
						<!--<div class="why-we__box">
							...
							<div class="why-we__box__img">
								<img src="/image/pictures/why-we5.png" alt="why-we1">
							</div>
						</div>
						<div class="why-we__box">
							<div class="why-we__box__description">
								<h4 class="why-we__box__title">АКЦИИ И СКИДКИ</h4>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut doloremque laudantium, totam rem apem.</p>
							</div>
							<div class="why-we__box__img">
								<img src="/image/pictures/why-we6.png" alt="why-we1">
							</div>
						</div>
						<div class="why-we__box">
							<div class="why-we__box__description">
								<h4 class="why-we__box__title">ИНДИВИДУАЛЬНЫЙ ПОДХОД</h4>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut doloremque laudantium, totam rem apem.</p>
							</div>
							<div class="why-we__box__img">
                ...
                <?php //foreach ($categories as $category) { ?>
                        ...
                        <?php //if ($category['name'] == "home_category") { ?>
                            <?php //foreach ($category['children'] as $child) { ?>
                                <!--<a href="<?php echo $child['href']; ?>" class="food-menu__nav__link"><?php echo $child['name']; ?></a>-->
                            <?php //} ?>
                        <?php //} ?>        
