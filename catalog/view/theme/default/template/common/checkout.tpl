    ...
    ;
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $('#chekout__buttons').html('<a id="button-success"><img class="cart-form__buttons__ok" src="/image/pictures/ok.png" alt="close"></a><a id="button-cancel" class="close-order cart-menu "><img class="cart-form__buttons__close" src="/image/pictures/close.png" alt="close"></a>');
...
//$(document).ready(function() {
    $.ajax({
        ...
        success: function(html) {
            ...
            //$('#collapse-payment-address .panel-body').html(html);
            $('#collapse-payment-address').html(html);
            //$('#collapse-checkout-option div').remove();
            
            $("#collapse-checkout-option").children().remove();
...
$(document).delegate('#button-register', 'click', function() {
    //console.log($('#collapse-payment-address input[type=\'text\'], #collapse-payment-address input[type=\'date\'], #collapse-payment-address input[type=\'datetime-local\'], #collapse-payment-address input[type=\'time\'], #collapse-payment-address input[type=\'password\'], #collapse-payment-address input[type=\'hidden\'], #collapse-payment-address input[type=\'checkbox\']:checked, #collapse-payment-address input[type=\'radio\']:checked, #collapse-payment-address textarea, #collapse-payment-address select'));
    $.ajax({
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (json['error']['warning']) {
                    $('#collapse-payment-address').prepend('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error']['warning'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
                }
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                //console.log($('#collapse-payment-address option:selected').val());
                //console.log($('input[name="payment_address"]:checked').val());
                if($('input[name="payment_address"]:checked').val()==="existing"){
                    var selected_id=$('#collapse-payment-address option:selected').val();
                }else{
                    var selected_id="last";
                }
                <?php if ($shipping_required) { ?>
                <?php //if (true) { ?>
                $.ajax({
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (json['error']['warning']) {
                    $('#collapse-shipping-method').prepend('<div class="alert alert-warning">' + json['error']['warning'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
                }
            } else {
                $.ajax({
                    url: 'index.php?route=checkout/payment_method',
...
$(document).delegate('#button-success', 'click', function() {
<?php if ($logged) { ?>
        $.ajax({
        url: 'index.php?route=checkout/payment_address/save',
        type: 'post',
...
<?php } else { ?>
    ...
    if ($("input").is("#input-payment-password")){
        console.log("рег до")
    ...
    } else if($("div").is("#payment-existing")){
        console.log("рег после подтверждения")
        $.ajax({
        url: 'index.php?route=checkout/payment_address/save',
        type: 'post',
        data: $('#collapse-payment-address input[type=\'text\'], #collapse-payment-address input[type=\'date\'], #collapse-payment-address input[type=\'datetime-local\'], #collapse-payment-address input[type=\'time\'], #collapse-payment-address input[type=\'password\'], #collapse-payment-address input[type=\'checkbox\']:checked, #collapse-payment-address input[type=\'radio\']:checked, #collapse-payment-address input[type=\'hidden\'], #collapse-payment-address textarea, #collapse-payment-address select'),
