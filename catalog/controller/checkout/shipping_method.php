		...
		//if (isset($this->session->data['shipping_address'])) {
			...
			foreach ($results as $result) {
				if ($this->config->get($result['code'] . '_status')) {
					...
					$quote = $this->{'model_shipping_' . $result['code']}->getQuote(isset($this->session->data['shipping_address']) ? $this->session->data['shipping_address'] : true);
                    //var_dump($this->{'model_shipping_' . $result['code']}->getQuote(true));
